...
func (*GetNetworkResponse) Descriptor() ([]byte, []int) { return fileDescriptorServer, []int{9} }
...
func (*CreateNetworkRequest) Descriptor() ([]byte, []int) { return fileDescriptorServer, []int{10} }
...
func (*CreateNetworkResponse) Descriptor() ([]byte, []int) { return fileDescriptorServer, []int{11} }
...
func (*CreatePoolRequest) Descriptor() ([]byte, []int) { return fileDescriptorServer, []int{12} }
...
func (*CreatePoolResponse) Descriptor() ([]byte, []int) { return fileDescriptorServer, []int{13} }
...
var fileDescriptorServer = []byte{
	...
	,
}
