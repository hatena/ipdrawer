 ...
 * @param rangeStart
 * @param rangeEnd
 * @return *ServerpbDeletePoolResponse
 */
func (a PoolServiceV0Api) DeletePool(rangeStart string, rangeEnd string) (*ServerpbDeletePoolResponse, *APIResponse, error) {

	var localVarHttpMethod = strings.ToUpper("Post")
	// create path and map variables
	localVarPath := a.Configuration.BasePath + "/api/v0/pool/{range_start}/{range_end}/delete"
	...
	var successPayload = new(ServerpbDeletePoolResponse)
	localVarHttpResponse, err := a.Configuration.APIClient.CallAPI(localVarPath, localVarHttpMethod, localVarPostBody, localVarHeaderParams, localVarQueryParams, localVarFormParams, localVarFileName, localVarFileBytes)

	var localVarURL, _ = url.Parse(localVarPath)
	localVarURL.RawQuery = localVarQueryParams.Encode()
	var localVarAPIResponse = &APIResponse{Operation: "DeletePool", Method: localVarHttpMethod, RequestURL: localVarURL.String()}
